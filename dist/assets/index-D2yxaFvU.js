...
Please change the parent <Route path="${X}"> to <Route path="${X==="/"?"*":`${X}/*`}">.`)}let O=Sn(),L;if(i){let X=typeof i=="string"?rl(i):i;Me(y==="/"||X.pathname?.startsWith(y),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${y}" but pathname "${X.pathname}" was given in the \`location\` prop.`),L=X}else L=O;let C=L.pathname||"/",N=C;if(y!=="/"){let X=y.replace(/^\//,"").split("/");N="/"+C.replace(/^\//,"").split("/").slice(X.length).join("/")}let T=Bm(l,{pathname:N});Lt(v||T!=null,`No routes matched location "${L.pathname}${L.search}${L.hash}" `),Lt(T==null||T[T.length-1].route.element!==void 0||T[T.length-1].route.Component!==void 0||T[T.length-1].route.lazy!==void 0,`Matched leaf route at location "${L.pathname}${L.search}${L.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let V=dy(T&&T.map(X=>Object.assign({},X,{params:Object.assign({},b,X.params),pathname:bn([y,d.encodeLocation?d.encodeLocation(X.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:X.pathname]),pathnameBase:X.pathnameBase==="/"?y:bn([y,d.encodeLocation?d.encodeLocation(X.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:X.pathnameBase])})),h,c,s,f);return i&&V?E.createElement(hi.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...L},navigationType:"POP"}},V):V}function sy(){let l=by(),i=Fx(l)?`${l.status} ${l.statusText}`:l instanceof Error?l.message:JSON.stringify(l),c=l instanceof Error?l.stack:null,s="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:s},d={padding:"2px 4px",backgroundColor:s},h=null;return console.error("Error handled by React Router default ErrorBoundary:",l),h=E.createElement(E.Fragment,null,E.createElement("p",null,"💿 Hey developer 👋"),E.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",E.createElement("code",{style:d},"ErrorBoundary")," or"," ",E.createElement("code",{style:d},"errorElement")," prop on your route.")),E.createElement(E.Fragment,null,E.createElement("h2",null,"Unexpected Application Error!"),E.createElement("h3",{style:{fontStyle:"italic"}},i),c?E.createElement("pre",{style:f},c):null,h)}var cy=E.createElement(sy,null),Fm=class extends E.Component{constructor(l){super(l),this.state={location:l.location,revalidation:l.revalidation,error:l.error}}static getDerivedStateFromError(l){return{error:l}}static getDerivedStateFromProps(l,i){return i.location!==l.location||i.revalidation!=="idle"&&l.revalidation==="idle"?{error:l.error,location:l.location,revalidation:l.revalidation}:{error:l.error!==void 0?l.error:i.error,location:i.location,revalidation:l.revalidation||i.revalidation}}componentDidCatch(l,i){this.props.onError?this.props.onError(l,i):console.error("React Router caught the following error during render",l)}render(){let l=this.state.error;if(this.context&&typeof l=="object"&&l&&"digest"in l&&typeof l.digest=="string"){const c=ly(l.digest);c&&(l=c)}let i=l!==void 0?E.createElement($t.Provider,{value:this.props.routeContext},E.createElement(wu.Provider,{value:l,children:this.props.component})):this.props.children;return this.context?E.createElement(uy,{error:l},i):i}};Fm.contextType=Px;var Fc=new WeakMap;function uy({children:l,error:i}){let{basename:c}=E.useContext(Tt);if(typeof i=="object"&&i&&"digest"in i&&typeof i.digest=="string"){let s=ay(i.digest);if(s){let f=Fc.get(i);if(f)throw f;let d=Vm(s.location,c);if(Ym&&!Fc.get(i))if(d.isExternal||s.reloadDocument)window.location.href=d.absoluteURL||d.to;else{const h=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(d.to,{replace:s.replace}));throw Fc.set(i,h),h}return E.createElement("meta",{httpEquiv:"refresh",content:`0;url=${d.absoluteURL||d.to}`})}}return l}function fy({routeContext:l,match:i,children:c}){let s=E.useContext(ol);return s&&s.static&&s.staticContext&&(i.route.errorElement||i.route.ErrorBoundary)&&(s.staticContext._deepestRenderedBoundaryId=i.route.id),E.createElement($t.Provider,{value:l},c)}function dy(l,i=[],c=null,s=null,f=null){if(l==null){if(!c)return null;if(c.errors)l=c.matches;else if(i.length===0&&!c.initialized&&c.matches.length>0)l=c.matches;else return null}let d=l,h=c?.errors;if(h!=null){let y=d.findIndex(v=>v.route.id&&h?.[v.route.id]!==void 0);Me(y>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(h).join(",")}`),d=d.slice(0,Math.min(d.length,y+1))}let x=!1,b=-1;if(c)for(let y=0;y<d.length;y++){let v=d[y];if((v.route.HydrateFallback||v.route.hydrateFallbackElement)&&(b=y),v.route.id){let{loaderData:O,errors:L}=c,C=v.route.loader&&!O.hasOwnProperty(v.route.id)&&(!L||L[v.route.id]===void 0);if(v.route.lazy||C){x=!0,b>=0?d=d.slice(0,b+1):d=[d[0]];break}}}let g=c&&s?(y,v)=>{s(y,{location:c.location,params:c.matches?.[0]?.params??{},unstable_pattern:$x(c.matches),errorInfo:v})}:void 0;return d.reduceRight((y,v,O)=>{let L,C=!1,N=null,T=null;c&&(L=h&&v.route.id?h[v.route.id]:void 0,N=v.route.errorElement||cy,x&&(b<0&&O===0?($m("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),C=!0,T=null):b===O&&(C=!0,T=v.route.hydrateFallbackElement||null)));let V=i.concat(d.slice(0,O+1)),X=()=>{let G;return L?G=N:C?G=T:v.route.Component?G=E.createElement(v.route.Component,null):v.route.element?G=v.route.element:G=y,E.createElement(fy,{match:v,routeContext:{outlet:y,matches:V,isDataRoute:c!=null},children:G})};return c&&(v.route.ErrorBoundary||v.route.errorElement||O===0)?E.createElement(Fm,{location:c.location,revalidation:c.revalidation,component:N,error:L,children:X(),routeContext:{outlet:null,matches:V,isDataRoute:!0},onError:g}):X()},null)}function ju(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function py(l){let i=E.useContext(ol);return Me(i,ju(l)),i}function hy(l){let i=E.useContext(co);return Me(i,ju(l)),i}function my(l){let i=E.useContext($t);return Me(i,ju(l)),i}function Nu(l){let i=my(l),c=i.matches[i.matches.length-1];return Me(c.route.id,`${l} can only be used on routes that contain a unique "id"`),c.route.id}function gy(){return Nu("useRouteId")}function by(){let l=E.useContext(wu),i=hy("useRouteError"),c=Nu("useRouteError");return l!==void 0?l:i.errors?.[c]}function xy(){let{router:l}=py("useNavigate"),i=Nu("useNavigate"),c=E.useRef(!1);return Jm(()=>{c.current=!0}),E.useCallback(async(f,d={})=>{Lt(c.current,Zm),c.current&&(typeof f=="number"?await l.navigate(f):await l.navigate(f,{fromRouteId:i,...d}))},[l,i])}var Ph={};function $m(l,i,c){!i&&!Ph[l]&&(Ph[l]=!0,Lt(!1,c))}E.memo(yy);function yy({routes:l,future:i,state:c,onError:s}){return Km(l,void 0,c,s,i)}function Wm({to:l,replace:i,state:c,relative:s}){Me(sl(),"<Navigate> may be used only in the context of a <Router> component.");let{static:f}=E.useContext(Tt);Lt(!f,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:d}=E.useContext($t),{pathname:h}=Sn(),x=wn(),b=Su(l,vu(d),h,s==="path"),g=JSON.stringify(b);return E.useEffect(()=>{x(JSON.parse(g),{replace:i,state:c,relative:s})},[x,g,s,i,c]),null}function pa(l){Me(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function vy({basename:l="/",children:i=null,location:c,navigationType:s="POP",navigator:f,static:d=!1,unstable_useTransitions:h}){Me(!sl(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let x=l.replace(/^\/*/,"/"),b=E.useMemo(()=>({basename:x,navigator:f,static:d,unstable_useTransitions:h,future:{}}),[x,f,d,h]);typeof c=="string"&&(c=rl(c));let{pathname:g="/",search:y="",hash:v="",state:O=null,key:L="default"}=c,C=E.useMemo(()=>{let N=yn(g,x);return N==null?null:{location:{pathname:N,search:y,hash:v,state:O,key:L},navigationType:s}},[x,g,y,v,O,L,s]);return Lt(C!=null,`<Router basename="${x}"> is not able to match the URL "${g}${y}${v}" because it does not start with the basename, so the <Router> won't render anything.`),C==null?null:E.createElement(Tt.Provider,{value:b},E.createElement(hi.Provider,{children:i,value:C}))}function Sy({children:l,location:i}){return oy(ou(l),i)}function ou(l,i=[]){let c=[];return E.Children.forEach(l,(s,f)=>{if(!E.isValidElement(s))return;let d=[...i,f];if(s.type===E.Fragment){c.push.apply(c,ou(s.props.children,d));return}Me(s.type===pa,`[${typeof s.type=="string"?s.type:s.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Me(!s.props.index||!s.props.children,"An index route cannot have child routes.");let h={id:s.props.id||d.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,middleware:s.props.middleware,loader:s.props.loader,action:s.props.action,hydrateFallbackElement:s.props.hydrateFallbackElement,HydrateFallback:s.props.HydrateFallback,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.hasErrorBoundary===!0||s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(h.children=ou(s.props.children,d)),c.push(h)}),c}var Qr="get",Zr="application/x-www-form-urlencoded";function uo(l){return typeof HTMLElement<"u"&&l instanceof HTMLElement}function wy(l){return uo(l)&&l.tagName.toLowerCase()==="button"}function jy(l){return uo(l)&&l.tagName.toLowerCase()==="form"}function Ny(l){return uo(l)&&l.tagName.toLowerCase()==="input"}function Ey(l){return!!(l.metaKey||l.altKey||l.ctrlKey||l.shiftKey)}function zy(l,i){return l.button===0&&(!i||i==="_self")&&!Ey(l)}var Hr=null;function Ty(){if(Hr===null)try{new FormData(document.createElement("form"),0),Hr=!1}catch{Hr=!0}return Hr}var Cy=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function $c(l){return l!=null&&!Cy.has(l)?(Lt(!1,`"${l}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Zr}"`),null):l}function Ay(l,i){let c,s,f,d,h;if(jy(l)){let x=l.getAttribute("action");s=x?yn(x,i):null,c=l.getAttribute("method")||Qr,f=$c(l.getAttribute("enctype"))||Zr,d=new FormData(l)}else if(wy(l)||Ny(l)&&(l.type==="submit"||l.type==="image")){let x=l.form;if(x==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=l.getAttribute("formaction")||x.getAttribute("action");if(s=b?yn(b,i):null,c=l.getAttribute("formmethod")||x.getAttribute("method")||Qr,f=$c(l.getAttribute("formenctype"))||$c(x.getAttribute("enctype"))||Zr,d=new FormData(x,l),!Ty()){let{name:g,type:y,value:v}=l;if(y==="image"){let O=g?`${g}.`:"";d.append(`${O}x`,"0"),d.append(`${O}y`,"0")}else g&&d.append(g,v)}}else{if(uo(l))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');c=Qr,s=null,f=Zr,h=l}return d&&f==="text/plain"&&(h=d,d=void 0),{action:s,method:c.toLowerCase(),encType:f,formData:d,body:h}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Eu(l,i){if(l===!1||l===null||typeof l>"u")throw new Error(i)}function Ry(l,i,c,s){let f=typeof l=="string"?new URL(l,typeof window>"u"?"server://singlefetch/":window.location.origin):l;return c?f.pathname.endsWith("/")?f.pathname=`${f.pathname}_.${s}`:f.pathname=`${f.pathname}.${s}`:f.pathname==="/"?f.pathname=`_root.${s}`:i&&yn(f.pathname,i)==="/"?f.pathname=`${i.replace(/\/$/,"")}/_root.${s}`:f.pathname=`${f.pathname.replace(/\/$/,"")}.${s}`,f}async function _y(l,i){if(l.id in i)return i[l.id];try{let c=await import(l.module);return i[l.id]=c,c}catch(c){return console.error(`Error loading route module \`${l.module}\`, reloading page...`),console.error(c),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Oy(l){return l==null?!1:l.href==null?l.rel==="preload"&&typeof l.imageSrcSet=="string"&&typeof l.imageSizes=="string":typeof l.rel=="string"&&typeof l.href=="string"}async function Dy(l,i,c){let s=await Promise.all(l.map(async f=>{let d=i.routes[f.route.id];if(d){let h=await _y(d,c);return h.links?h.links():[]}return[]}));return By(s.flat(1).filter(Oy).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function Ih(l,i,c,s,f,d){let h=(b,g)=>c[g]?b.route.id!==c[g].route.id:!0,x=(b,g)=>c[g].pathname!==b.pathname||c[g].route.path?.endsWith("*")&&c[g].params["*"]!==b.params["*"];return d==="assets"?i.filter((b,g)=>h(b,g)||x(b,g)):d==="data"?i.filter((b,g)=>{let y=s.routes[b.route.id];if(!y||!y.hasLoader)return!1;if(h(b,g)||x(b,g))return!0;if(b.route.shouldRevalidate){let v=b.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:c[0]?.params||{},nextUrl:new URL(l,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof v=="boolean")return v}return!0}):[]}function My(l,i,{includeHydrateFallback:c}={}){return ky(l.map(s=>{let f=i.routes[s.route.id];if(!f)return[];let d=[f.module];return f.clientActionModule&&(d=d.concat(f.clientActionModule)),f.clientLoaderModule&&(d=d.concat(f.clientLoaderModule)),c&&f.hydrateFallbackModule&&(d=d.concat(f.hydrateFallbackModule)),f.imports&&(d=d.concat(f.imports)),d}).flat(1))}function ky(l){return[...new Set(l)]}function Uy(l){let i={},c=Object.keys(l).sort();for(let s of c)i[s]=l[s];return i}function By(l,i){let c=new Set;return new Set(i),l.reduce((s,f)=>{let d=JSON.stringify(Uy(f));return c.has(d)||(c.add(d),s.push({key:d,link:f})),s},[])}function Pm(){let l=E.useContext(ol);return Eu(l,"You must render this element inside a <DataRouterContext.Provider> element"),l}function Ly(){let l=E.useContext(co);return Eu(l,"You must render this element inside a <DataRouterStateContext.Provider> element"),l}var zu=E.createContext(void 0);zu.displayName="FrameworkContext";function Im(){let l=E.useContext(zu);return Eu(l,"You must render this element inside a <HydratedRouter> element"),l}function Hy(l,i){let c=E.useContext(zu),[s,f]=E.useState(!1),[d,h]=E.useState(!1),{onFocus:x,onBlur:b,onMouseEnter:g,onMouseLeave:y,onTouchStart:v}=i,O=E.useRef(null);E.useEffect(()=>{if(l==="render"&&h(!0),l==="viewport"){let N=V=>{V.forEach(X=>{h(X.isIntersecting)})},T=new IntersectionObserver(N,{threshold:.5});return O.current&&T.observe(O.current),()=>{T.disconnect()}}},[l]),E.useEffect(()=>{if(s){let N=setTimeout(()=>{h(!0)},100);return()=>{clearTimeout(N)}}},[s]);let L=()=>{f(!0)},C=()=>{f(!1),h(!1)};return c?l!=="intent"?[d,O,{}]:[d,O,{onFocus:ri(x,L),onBlur:ri(b,C),onMouseEnter:ri(g,L),onMouseLeave:ri(y,C),onTouchStart:ri(v,L)}]:[!1,O,{}]}function ri(l,i){return c=>{l&&l(c),c.defaultPrevented||i(c)}}function qy({page:l,...i}){let{router:c}=Pm(),s=E.useMemo(()=>Bm(c.routes,l,c.basename),[c.routes,l,c.basename]);return s?E.createElement(Vy,{page:l,matches:s,...i}):null}function Yy(l){let{manifest:i,routeModules:c}=Im(),[s,f]=E.useState([]);return E.useEffect(()=>{let d=!1;return Dy(l,i,c).then(h=>{d||f(h)}),()=>{d=!0}},[l,i,c]),s}function Vy({page:l,matches:i,...c}){let s=Sn(),{future:f,manifest:d,routeModules:h}=Im(),{basename:x}=Pm(),{loaderData:b,matches:g}=Ly(),y=E.useMemo(()=>Ih(l,i,g,d,s,"data"),[l,i,g,d,s]),v=E.useMemo(()=>Ih(l,i,g,d,s,"assets"),[l,i,g,d,s]),O=E.useMemo(()=>{if(l===s.pathname+s.search+s.hash)return[];let N=new Set,T=!1;if(i.forEach(X=>{let G=d.routes[X.route.id];!G||!G.hasLoader||(!y.some(F=>F.route.id===X.route.id)&&X.route.id in b&&h[X.route.id]?.shouldRevalidate||G.hasClientLoader?T=!0:N.add(X.route.id))}),N.size===0)return[];let V=Ry(l,x,f.unstable_trailingSlashAwareDataRequests,"data");return T&&N.size>0&&V.searchParams.set("_routes",i.filter(X=>N.has(X.route.id)).map(X=>X.route.id).join(",")),[V.pathname+V.search]},[x,f.unstable_trailingSlashAwareDataRequests,b,s,d,y,i,l,h]),L=E.useMemo(()=>My(v,d),[v,d]),C=Yy(v);return E.createElement(E.Fragment,null,O.map(N=>E.createElement("link",{key:N,rel:"prefetch",as:"fetch",href:N,...c})),L.map(N=>E.createElement("link",{key:N,rel:"modulepreload",href:N,...c})),C.map(({key:N,link:T})=>E.createElement("link",{key:N,nonce:c.nonce,...T})))}function Gy(...l){return i=>{l.forEach(c=>{typeof c=="function"?c(i):c!=null&&(c.current=i)})}}var Xy=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Xy&&(window.__reactRouterVersion="7.12.0")}catch{}function Qy({basename:l,children:i,unstable_useTransitions:c,window:s}){let f=E.useRef();f.current==null&&(f.current=Ex({window:s,v5Compat:!0}));let d=f.current,[h,x]=E.useState({action:d.action,location:d.location}),b=E.useCallback(g=>{c===!1?x(g):E.startTransition(()=>x(g))},[c]);return E.useLayoutEffect(()=>d.listen(b),[d,b]),E.createElement(vy,{basename:l,children:i,location:h.location,navigationType:h.action,navigator:d,unstable_useTransitions:c})}var eg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,tg=E.forwardRef(function({onClick:i,discover:c="render",prefetch:s="none",relative:f,reloadDocument:d,replace:h,state:x,target:b,to:g,preventScrollReset:y,viewTransition:v,unstable_defaultShouldRevalidate:O,...L},C){let{basename:N,unstable_useTransitions:T}=E.useContext(Tt),V=typeof g=="string"&&eg.test(g),X=Vm(g,N);g=X.to;let G=iy(g,{relative:f}),[F,$,ee]=Hy(s,L),J=Fy(g,{replace:h,state:x,target:b,preventScrollReset:y,relative:f,viewTransition:v,unstable_defaultShouldRevalidate:O,unstable_useTransitions:T});function le(Re){i&&i(Re),Re.defaultPrevented||J(Re)}let me=E.createElement("a",{...L,...ee,href:X.absoluteURL||G,onClick:X.isExternal||d?i:le,ref:Gy(C,$),target:b,"data-discover":!V&&c==="render"?"true":void 0});return F&&!V?E.createElement(E.Fragment,null,me,E.createElement(qy,{page:G})):me});tg.displayName="Link";var Zy=E.forwardRef(function({"aria-current":i="page",caseSensitive:c=!1,className:s="",end:f=!1,style:d,to:h,viewTransition:x,children:b,...g},y){let v=mi(h,{relative:g.relative}),O=Sn(),L=E.useContext(co),{navigator:C,basename:N}=E.useContext(Tt),T=L!=null&&e1(v)&&x===!0,V=C.encodeLocation?C.encodeLocation(v).pathname:v.pathname,X=O.pathname,G=L&&L.navigation&&L.navigation.location?L.navigation.location.pathname:null;c||(X=X.toLowerCase(),G=G?G.toLowerCase():null,V=V.toLowerCase()),G&&N&&(G=yn(G,N)||G);const F=V!=="/"&&V.endsWith("/")?V.length-1:V.length;let $=X===V||!f&&X.startsWith(V)&&X.charAt(F)==="/",ee=G!=null&&(G===V||!f&&G.startsWith(V)&&G.charAt(V.length)==="/"),J={isActive:$,isPending:ee,isTransitioning:T},le=$?i:void 0,me;typeof s=="function"?me=s(J):me=[s,$?"active":null,ee?"pending":null,T?"transitioning":null].filter(Boolean).join(" ");let Re=typeof d=="function"?d(J):d;return E.createElement(tg,{...g,"aria-current":le,className:me,ref:y,style:Re,to:h,viewTransition:x},typeof b=="function"?b(J):b)});Zy.displayName="NavLink";var Jy=E.forwardRef(({discover:l="render",fetcherKey:i,navigate:c,reloadDocument:s,replace:f,state:d,method:h=Qr,action:x,onSubmit:b,relative:g,preventScrollReset:y,viewTransition:v,unstable_defaultShouldRevalidate:O,...L},C)=>{let{unstable_useTransitions:N}=E.useContext(Tt),T=Py(),V=Iy(x,{relative:g}),X=h.toLowerCase()==="get"?"get":"post",G=typeof x=="string"&&eg.test(x),F=$=>{if(b&&b($),$.defaultPrevented)return;$.preventDefault();let ee=$.nativeEvent.submitter,J=ee?.getAttribute("formmethod")||h,le=()=>T(ee||$.currentTarget,{fetcherKey:i,method:J,navigate:c,replace:f,state:d,relative:g,preventScrollReset:y,viewTransition:v,unstable_defaultShouldRevalidate:O});N&&c!==!1?E.startTransition(()=>le()):le()};return E.createElement("form",{ref:C,method:X,action:V,onSubmit:s?b:F,...L,"data-discover":!G&&l==="render"?"true":void 0})});Jy.displayName="Form";function Ky(l){return`${l} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function ng(l){let i=E.useContext(ol);return Me(i,Ky(l)),i}function Fy(l,{target:i,replace:c,state:s,preventScrollReset:f,relative:d,viewTransition:h,unstable_defaultShouldRevalidate:x,unstable_useTransitions:b}={}){let g=wn(),y=Sn(),v=mi(l,{relative:d});return E.useCallback(O=>{if(zy(O,i)){O.preventDefault();let L=c!==void 0?c:ui(y)===ui(v),C=()=>g(l,{replace:L,state:s,preventScrollReset:f,relative:d,viewTransition:h,unstable_defaultShouldRevalidate:x});b?E.startTransition(()=>C()):C()}},[y,g,v,c,s,i,l,f,d,h,x,b])}var $y=0,Wy=()=>`__${String(++$y)}__`;function Py(){let{router:l}=ng("useSubmit"),{basename:i}=E.useContext(Tt),c=gy(),s=l.fetch,f=l.navigate;return E.useCallback(async(d,h={})=>{let{action:x,method:b,encType:g,formData:y,body:v}=Ay(d,i);if(h.navigate===!1){let O=h.fetcherKey||Wy();await s(O,c,h.action||x,{unstable_defaultShouldRevalidate:h.unstable_defaultShouldRevalidate,preventScrollReset:h.preventScrollReset,formData:y,body:v,formMethod:h.method||b,formEncType:h.encType||g,flushSync:h.flushSync})}else await f(h.action||x,{unstable_defaultShouldRevalidate:h.unstable_defaultShouldRevalidate,preventScrollReset:h.preventScrollReset,formData:y,body:v,formMethod:h.method||b,formEncType:h.encType||g,replace:h.replace,state:h.state,fromRouteId:c,flushSync:h.flushSync,viewTransition:h.viewTransition})},[s,f,i,c])}function Iy(l,{relative:i}={}){let{basename:c}=E.useContext(Tt),s=E.useContext($t);Me(s,"useFormAction must be used inside a RouteContext");let[f]=s.matches.slice(-1),d={...mi(l||".",{relative:i})},h=Sn();if(l==null){d.search=h.search;let x=new URLSearchParams(d.search),b=x.getAll("index");if(b.some(y=>y==="")){x.delete("index"),b.filter(v=>v).forEach(v=>x.append("index",v));let y=x.toString();d.search=y?`?${y}`:""}}return(!l||l===".")&&f.route.index&&(d.search=d.search?d.search.replace(/^\?/,"?index&"):"?index"),c!=="/"&&(d.pathname=d.pathname==="/"?c:bn([c,d.pathname])),ui(d)}function e1(l,{relative:i}={}){let c=E.useContext(Xm);Me(c!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:s}=ng("useViewTransitionState"),f=mi(l,{relative:i});if(!c.isTransitioning)return!1;let d=yn(c.currentLocation.pathname,s)||c.currentLocation.pathname,h=yn(c.nextLocation.pathname,s)||c.nextLocation.pathname;return Pr(f.pathname,h)!=null||Pr(f.pathname,d)!=null}const ag="/assets/vvcmclogo-C6hbLrf7.jpg";function t1(){const l=wn(),i=Sn(),[c,s]=E.useState(!1),[f,d]=E.useState(!1),h=(()=>{try{return JSON.parse(localStorage.getItem("citizenUser")||"null")}catch{return null}})();E.useEffect(()=>{const g=()=>{d(window.scrollY>20)};return window.addEventListener("scroll",g),()=>window.removeEventListener("scroll",g)},[]);const x=()=>{localStorage.removeItem("citizenUser"),l("/login"),s(!1)},b=g=>i.pathname===g;return u.jsxs(u.Fragment,{children:[u.jsx("style",{children:`
      ...
      `}),u.jsxs("div",{className:"home-root",children:[u.jsxs("div",{className:"hero",children:[u.jsxs("div",{className:"hero-orbit","aria-hidden":"true",children:[u.jsx("div",{className:"hero-float f1",children:"📅"}),u.jsx("div",{className:"hero-float f2",children:"👥"}),u.jsx("div",{className:"hero-float f3",children:"📅"}),u.jsx("div",{className:"hero-float f4",children:"👤"})]}),u.jsx("h1",{className:"hero-jansanwad",children:"जन संवाद"}),u.jsx("div",{className:"hero-title-underline"}),u.jsx("p",{className:"hero-desc",children:"नागरिकांना त्यांच्या समस्या व सूचना मा. महापौर श्री. अजिव पाटील यांच्यापर्यंत थेट पोहोचवण्यासाठी तयार केलेले संवाद व्यासपीठ"}),u.jsx("div",{className:"hero-btns",children:i?u.jsxs(u.Fragment,{children:[u.jsx("button",{className:"hero-btn-primary",onClick:()=>l("/book-appointment"),children:"📅 Book Appointment"}),u.jsx("button",{className:"hero-btn-outline",onClick:()=>l("/my-appointments"),children:"📋 My Appointments"})]}):u.jsxs(u.Fragment,{children:[u.jsx("button",{className:"hero-btn-primary",onClick:()=>l("/register"),children:"🚀 Get Started — Register"}),u.jsx("button",{className:"hero-btn-outline",onClick:()=>l("/login"),children:"Login करा"})]})})]}),u.jsx("div",{className:"hiw-section",children:u.jsxs("div",{className:"hiw-inner",children:[u.jsxs("div",{className:"hiw-header",children:[u.jsx("h2",{className:"hiw-title",children:"कसे काम करते?"}),u.jsx("div",{className:"hiw-title-bar"}),u.jsx("p",{className:"hiw-sub",children:"फक्त 4 सोप्या steps मध्ये Mayor ची भेट बुक करा"})]}),u.jsxs("div",{className:"hiw-grid-wrap",children:[u.jsx("div",{className:"hiw-connector","aria-hidden":"true"}),u.jsx("div",{className:"hiw-grid",children:y.map((O,L)=>u.jsxs("div",{className:"hiw-card",children:[u.jsx("div",{className:"hiw-num",children:L+1}),u.jsx("div",{className:"hiw-icon-wrap",children:u.jsx(oi,{src:O.lottie,style:{width:44,height:44}})}),u.jsx("div",{className:"hiw-step-title",children:O.title}),u.jsx("div",{className:"hiw-step-desc",children:O.desc})]},L))})]})]})}),u.jsxs("div",{className:"mayor-section",children:[u.jsxs("div",{className:"mayor-left",children:[u.jsx("p",{className:"mayor-heading-line1",children:"मा. महापौर"}),u.jsx("p",{className:"mayor-heading-line2",children:"श्री. अजीव पाटील"}),u.jsx("p",{className:"mayor-bio",children:"३ फेब्रुवारी २०२६ रोजी महापौरपदाची सूत्रे स्वीकारल्यापासून मा. महापौर श्री. अजीव पाटील यांनी नागरिकांशी थेट संवाद साधण्यासाठी हे जन संवाद व्यासपीठ उभारले आहे. नागरिकांच्या समस्या, सूचना आणि तक्रारी थेट महापौरांपर्यंत पोहोचाव्यात यासाठी हे पारदर्शक, सोपे आणि जलद ऑनलाइन माध्यम तयार केले आहे."}),u.jsx("button",{className:"mayor-btn-primary",onClick:()=>l(i?"/book-appointment":"/register"),children:"📅 Appointment बुक करा"})]}),u.jsxs("div",{className:"mayor-right",children:[u.jsx("div",{className:"mayor-chevrons","aria-hidden":"true",children:u.jsxs("svg",{width:"200",height:"200",viewBox:"0 0 200 200",fill:"none",children:[u.jsxs("g",{opacity:"0.2",stroke:"#7edede",strokeWidth:"1.4",fill:"none",children:[u.jsx("polyline",{points:"160,8 178,26 160,44"}),u.jsx("polyline",{points:"142,8 160,26 142,44"}),u.jsx("polyline",{points:"124,8 142,26 124,44"}),u.jsx("polyline",{points:"160,44 178,62 160,80"}),u.jsx("polyline",{points:"142,44 160,62 142,80"}),u.jsx("polyline",{points:"124,44 142,62 124,80"}),u.jsx("polyline",{points:"168,80 186,98 168,116"}),u.jsx("polyline",{points:"150,80 168,98 150,116"}),u.jsx("polyline",{points:"168,116 186,134 168,152"}),u.jsx("polyline",{points:"150,116 168,134 150,152"})]}),u.jsx("circle",{cx:"182",cy:"18",r:"16",fill:"rgba(81,200,200,0.3)",stroke:"rgba(81,200,200,0.4)",strokeWidth:"1"}),u.jsx("rect",{x:"108",y:"4",width:"10",height:"10",rx:"1",transform:"rotate(45 113 9)",fill:"#7edede",opacity:"0.3"})]})}),u.jsx("div",{className:"mayor-diamond-tl","aria-hidden":"true",children:u.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",children:u.jsx("rect",{x:"2",y:"2",width:"12",height:"12",rx:"1",transform:"rotate(45 8 8)",fill:"#7edede",opacity:"0.45"})})}),u.jsx("div",{className:"mayor-diamond-mid","aria-hidden":"true",children:u.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12",children:u.jsx("rect",{x:"1.5",y:"1.5",width:"9",height:"9",rx:"1",transform:"rotate(45 6 6)",fill:"#c9a040",opacity:"0.4"})})}),u.jsx("div",{className:"mayor-gold-tri","aria-hidden":"true",children:u.jsxs("svg",{width:"160",height:"110",viewBox:"0 0 160 110",fill:"none",children:[u.jsx("polygon",{points:"160,110 160,0 50,110",fill:"#C9963A",opacity:"0.25"}),u.jsx("polygon",{points:"160,110 160,40 95,110",fill:"#e8b84b",opacity:"0.18"})]})}),u.jsx("div",{className:"mayor-sparkle","aria-hidden":"true",children:u.jsx("svg",{width:"28",height:"28",viewBox:"0 0 28 28",fill:"none",children:u.jsx("path",{d:"M14 2 L15.5 12.5 L26 14 L15.5 15.5 L14 26 L12.5 15.5 L2 14 L12.5 12.5 Z",fill:"white",opacity:"0.7"})})}),u.jsx("div",{className:"mayor-phone-glow","aria-hidden":"true"}),u.jsxs("div",{className:"mayor-bubbles-col",children:[u.jsx("div",{className:"mayor-bubble-item",children:u.jsxs("svg",{width:"26",height:"26",viewBox:"0 0 26 26",fill:"none",children:[u.jsx("rect",{x:"4",y:"4",width:"18",height:"13",rx:"3",stroke:"rgba(255,255,255,0.85)",strokeWidth:"1.5",fill:"none"}),u.jsx("path",{d:"M8 20 L8 17",stroke:"rgba(255,255,255,0.7)",strokeWidth:"1.5",strokeLinecap:"round"}),u.jsx("path",{d:"M7 7h12M7 10h8M7 13h10",stroke:"rgba(255,255,255,0.6)",strokeWidth:"1.2",strokeLinecap:"round"}),u.jsx("circle",{cx:"19",cy:"6",r:"4",fill:"#028945",stroke:"rgba(255,255,255,0.5)",strokeWidth:"1"}),u.jsx("path",{d:"M17 6h4M19 4v4",stroke:"white",strokeWidth:"1",strokeLinecap:"round"})]})}),u.jsx("div",{className:"mayor-bubble-item",children:u.jsxs("svg",{width:"26",height:"26",viewBox:"0 0 26 26",fill:"none",children:[u.jsx("polyline",{points:"5,19 10,12 15,15 21,7",stroke:"rgba(255,255,255,0.88)",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",fill:"none"}),u.jsx("polyline",{points:"17,7 21,7 21,11",stroke:"rgba(255,255,255,0.88)",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round",fill:"none"}),u.jsx("line",{x1:"5",y1:"21",x2:"21",y2:"21",stroke:"rgba(255,255,255,0.45)",strokeWidth:"1.2",strokeLinecap:"round"})]})}),u.jsx("div",{className:"mayor-bubble-item",children:u.jsxs("svg",{width:"26",height:"26",viewBox:"0 0 26 26",fill:"none",children:[u.jsx("circle",{cx:"13",cy:"8",r:"3.2",stroke:"rgba(255,255,255,0.85)",strokeWidth:"1.5",fill:"none"}),u.jsx("path",{d:"M7 21 C7 16.5 19 16.5 19 21",stroke:"rgba(255,255,255,0.85)",strokeWidth:"1.5",strokeLinecap:"round",fill:"none"}),u.jsx("circle",{cx:"6.5",cy:"10",r:"2.2",stroke:"rgba(255,255,255,0.6)",strokeWidth:"1.2",fill:"none"}),u.jsx("path",{d:"M3 20 C3 16.8 10 16.8 10 20",stroke:"rgba(255,255,255,0.5)",strokeWidth:"1.2",strokeLinecap:"round",fill:"none"}),u.jsx("circle",{cx:"19.5",cy:"10",r:"2.2",stroke:"rgba(255,255,255,0.6)",strokeWidth:"1.2",fill:"none"}),u.jsx("path",{d:"M16 20 C16 16.8 23 16.8 23 20",stroke:"rgba(255,255,255,0.5)",strokeWidth:"1.2",strokeLinecap:"round",fill:"none"}),u.jsx("path",{d:"M10 22.5 Q13 25 16 22.5",stroke:"rgba(255,255,255,0.35)",strokeWidth:"1",strokeLinecap:"round",fill:"none"})]})})]}),u.jsx("div",{className:"mayor-phone-wrap",children:u.jsx("div",{className:"mayor-phone",children:u.jsxs("div",{className:"mayor-phone-inner",children:[u.jsx("img",{src:n1,alt:"मा. महापौर श्री. अजीव पाटील",className:"mayor-phone-img"}),u.jsxs("div",{className:"mayor-phone-badge",children:[u.jsx("div",{className:"mayor-phone-badge-name",children:"मा. महापौर श्री. अजीव पाटील"}),u.jsx("div",{className:"mayor-phone-badge-title",children:"वसई-विरार शहर महानगरपालिका"})]})]})})})]})]}),u.jsx("div",{className:"projects-section",children:u.jsxs("div",{className:"projects-inner",children:[u.jsxs("div",{className:"section-header",children:[u.jsx("div",{className:"section-tag",children:"✦ सध्या सुरू"}),u.jsx("h2",{className:"section-title",children:"चालू प्रकल्प"}),u.jsx("p",{className:"section-sub",children:"वसई-विरार महानगरपालिकेचे सध्या प्रगतीत असलेले महत्त्वाचे प्रकल्प"})]}),u.jsxs("div",{className:"proj-card",onMouseEnter:()=>x(!1),onMouseLeave:()=>x(!0),style:v.bgimg?{backgroundImage:`linear-gradient(to right, rgba(255,255,255,0.92) 55%, ${v.accent}99 100%), url(${v.bgimg})`,backgroundSize:"cover",backgroundPosition:"center"}:{},children:[u.jsxs("div",{className:"proj-left",style:{background:"transparent",border:v.bgimg?"none":"1px solid rgba(81,171,172,0.12)",borderRight:"none"},children:[u.jsxs("div",{className:"proj-tag",style:{background:`${v.accent}18`,color:v.accent},children:[v.icon," ",v.tag]}),u.jsx("div",{className:"proj-title",children:v.title}),u.jsx("p",{className:"proj-desc",children:v.desc}),u.jsxs("div",{className:"proj-progress-row",children:[u.jsx("span",{className:"proj-progress-lbl",children:"प्रगती"}),u.jsxs("span",{className:"proj-progress-pct",style:{color:v.accent},children:[v.progress,"%"]})]}),u.jsx("div",{className:"proj-bar",children:u.jsx("div",{className:"proj-bar-fill",style:{width:`${v.progress}%`,background:`linear-gradient(90deg,${v.accent}88,${v.accent})`}})}),u.jsxs("div",{className:"proj-meta",children:[u.jsxs("div",{className:"proj-meta-item",children:["💰 ",u.jsx("strong",{children:v.budget})]}),u.jsxs("div",{className:"proj-meta-item",children:["📅 ",u.jsx("strong",{children:v.deadline})]}),u.jsx("span",{className:`proj-chip ${v.status==="ongoing"?"chip-ongoing":"chip-planning"}`,children:v.statusLabel})]})]}),u.jsxs("div",{className:"proj-right",style:{background:`linear-gradient(160deg,${v.accent},${v.accent}bb)`},children:[u.jsx("div",{className:"proj-icon",children:v.icon}),u.jsxs("div",{children:[u.jsx("div",{className:"proj-stat-num",children:v.stat}),u.jsx("div",{className:"proj-stat-lbl",children:v.statLbl})]})]})]}),u.jsxs("div",{className:"proj-nav",children:[u.jsx("button",{className:"proj-btn",onClick:()=>{x(!1),d(O=>(O-1+b.length)%b.length)},children:"‹"}),u.jsx("div",{className:"proj-dots",children:b.map((O,L)=>u.jsx("button",{className:`proj-dot${f===L?" active":""}`,onClick:()=>{x(!1),d(L)}},L))}),u.jsxs("span",{className:"proj-counter",children:[f+1," / ",b.length]}),u.jsx("button",{className:"proj-btn",onClick:()=>{x(!1),d(O=>(O+1)%b.length)},children:"›"})]})]})}),u.jsxs("div",{className:"faq-section",children:[u.jsx(oi,{src:"https://assets2.lottiefiles.com/packages/lf20_jcikwtux.json",style:{position:"absolute",left:30,top:"50%",transform:"translateY(-50%)",width:120,height:120,opacity:.18,pointerEvents:"none"}}),u.jsx(oi,{src:"https://assets2.lottiefiles.com/packages/lf20_jcikwtux.json",style:{position:"absolute",right:30,top:"50%",transform:"translateY(-50%)",width:120,height:120,opacity:.18,pointerEvents:"none"}}),u.jsxs("div",{className:"faq-inner",children:[u.jsx("div",{className:"faq-label",children:"FAQ"}),u.jsx("h2",{className:"faq-title",children:"वारंवार विचारले जाणारे प्रश्न"}),u.jsx("div",{className:"faq-list",children:g.map((O,L)=>u.jsxs("div",{className:`faq-item${c===L?" faq-active":""}`,children:[u.jsxs("button",{className:"faq-q",onClick:()=>s(c===L?null:L),children:[u.jsx("span",{className:"faq-q-text",children:O.q}),u.jsx("span",{className:"faq-icon",children:"+"})]}),u.jsx("div",{className:"faq-answer",children:u.jsx("p",{className:"faq-a-text",children:O.a})})]},L))})]})]}),u.jsxs("div",{className:"notice",children:[u.jsx("span",{className:"notice-icon",children:"⚠️"}),u.jsxs("div",{children:[u.jsx("div",{className:"notice-title",children:"महत्त्वाची सूचना"}),u.jsx("div",{className:"notice-text",children:"भेटीच्या दिवशी वेळेवर या. Token confirm झाल्याशिवाय भेट होणार नाही. Appointment confirm होण्यासाठी admin approval आवश्यक आहे. कोणत्याही अडचणीसाठी VVCMC कार्यालयाशी संपर्क करा."})]})]}),u.jsxs("div",{className:"cta",children:[u.jsx(oi,{src:"https://assets2.lottiefiles.com/packages/lf20_jcikwtux.json",style:{position:"absolute",left:60,top:"50%",transform:"translateY(-50%)",width:150,height:150,opacity:.1,pointerEvents:"none"}}),u.jsx(oi,{src:"https://assets9.lottiefiles.com/packages/lf20_touohxv0.json",style:{position:"absolute",right:60,top:"50%",transform:"translateY(-50%)",width:150,height:150,opacity:.1,pointerEvents:"none"}})]})]})]})}function lg(l,i){return function(){return l.apply(i,arguments)}}const{toString:r1}=Object.prototype,{getPrototypeOf:Cu}=Object,{iterator:fo,toStringTag:ig}=Symbol,po=(l=>i=>{const c=r1.call(i);return l[c]||(l[c]=c.slice(8,-1).toLowerCase())})(Object.create(null)),Xt=l=>(l=l.toLowerCase(),i=>po(i)===l),ho=l=>i=>typeof i===l,{isArray:cl}=Array,ll=ho("undefined");function gi(l){return l!==null&&!ll(l)&&l.constructor!==null&&!ll(l.constructor)&&ht(l.constructor.isBuffer)&&l.constructor.isBuffer(l)}const rg=Xt("ArrayBuffer");function o1(l){let i;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?i=ArrayBuffer.isView(l):i=l&&l.buffer&&rg(l.buffer),i}const s1=ho("string"),ht=ho("function"),og=ho("number"),bi=l=>l!==null&&typeof l=="object",c1=l=>l===!0||l===!1,Jr=l=>{if(po(l)!=="object")return!1;const i=Cu(l);return(i===null||i===Object.prototype||Object.getPrototypeOf(i)===null)&&!(ig in l)&&!(fo in l)},u1=l=>{if(!bi(l)||gi(l))return!1;try{return Object.keys(l).length===0&&Object.getPrototypeOf(l)===Object.prototype}catch{return!1}},f1=Xt("Date"),d1=Xt("File"),p1=Xt("Blob"),h1=Xt("FileList"),m1=l=>bi(l)&&ht(l.pipe),g1=l=>{let i;return l&&(typeof FormData=="function"&&l instanceof FormData||ht(l.append)&&((i=po(l))==="formdata"||i==="object"&&ht(l.toString)&&l.toString()==="[object FormData]"))},b1=Xt("URLSearchParams"),[x1,y1,v1,S1]=["ReadableStream","Request","Response","Headers"].map(Xt),w1=l=>l.trim?l.trim():l.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"");function xi(l,i,{allOwnKeys:c=!1}={}){if(l===null||typeof l>"u")return;let s,f;if(typeof l!="object"&&(l=[l]),cl(l))for(s=0,f=l.length;s<f;s++)i.call(null,l[s],s,l);else{if(gi(l))return;const d=c?Object.getOwnPropertyNames(l):Object.keys(l),h=d.length;let x;for(s=0;s<h;s++)x=d[s],i.call(null,l[x],x,l)}}function sg(l,i){if(gi(l))return null;i=i.toLowerCase();const c=Object.keys(l);let s=c.length,f;for(;s-- >0;)if(f=c[s],i===f.toLowerCase())return f;return null}const ha=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:global,cg=l=>!ll(l)&&l!==ha;function su(){const{caseless:l,skipUndefined:i}=cg(this)&&this||{},c={},s=(f,d)=>{const h=l&&sg(c,d)||d;Jr(c[h])&&Jr(f)?c[h]=su(c[h],f):Jr(f)?c[h]=su({},f):cl(f)?c[h]=f.slice():(!i||!ll(f))&&(c[h]=f)};for(let f=0,d=arguments.length;f<d;f++)arguments[f]&&xi(arguments[f],s);return c}const j1=(l,i,c,{allOwnKeys:s}={})=>(xi(i,(f,d)=>{c&&ht(f)?l[d]=lg(f,c):l[d]=f},{allOwnKeys:s}),l),N1=l=>(l.charCodeAt(0)===65279&&(l=l.slice(1)),l),E1=(l,i,c,s)=>{l.prototype=Object.create(i.prototype,s),l.prototype.constructor=l,Object.defineProperty(l,"super",{value:i.prototype}),c&&Object.assign(l.prototype,c)},z1=(l,i,c,s)=>{let f,d,h;const x={};if(i=i||{},l==null)return i;do{for(f=Object.getOwnPropertyNames(l),d=f.length;d-- >0;)h=f[d],(!s||s(h,l,i))&&!x[h]&&(i[h]=l[h],x[h]=!0);l=c!==!1&&Cu(l)}while(l&&(!c||c(l,i))&&l!==Object.prototype);return i},T1=(l,i,c)=>{l=String(l),(c===void 0||c>l.length)&&(c=l.length),c-=i.length;const s=l.indexOf(i,c);return s!==-1&&s===c},C1=l=>{if(!l)return null;if(cl(l))return l;let i=l.length;if(!og(i))return null;const c=new Array(i);for(;i-- >0;)c[i]=l[i];return c},A1=(l=>i=>l&&i instanceof l)(typeof Uint8Array<"u"&&Cu(Uint8Array)),R1=(l,i)=>{const s=(l&&l[fo]).call(l);let f;for(;(f=s.next())&&!f.done;){const d=f.value;i.call(l,d[0],d[1])}},_1=(l,i)=>{let c;const s=[];for(;(c=l.exec(i))!==null;)s.push(c);return s},O1=Xt("HTMLFormElement"),D1=l=>l.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g,function(c,s,f){return s.toUpperCase()+f}),em=(({hasOwnProperty:l})=>(i,c)=>l.call(i,c))(Object.prototype),M1=Xt("RegExp"),ug=(l,i)=>{const c=Object.getOwnPropertyDescriptors(l),s={};xi(c,(f,d)=>{let h;(h=i(f,d,l))!==!1&&(s[d]=h||f)}),Object.defineProperties(l,s)},k1=l=>{ug(l,(i,c)=>{if(ht(l)&&["arguments","caller","callee"].indexOf(c)!==-1)return!1;const s=l[c];if(ht(s)){if(i.enumerable=!1,"writable"in i){i.writable=!1;return}i.set||(i.set=()=>{throw Error("Can not rewrite read-only method '"+c+"'")})}})},U1=(l,i)=>{const c={},s=f=>{f.forEach(d=>{c[d]=!0})};return cl(l)?s(l):s(String(l).split(i)),c},B1=()=>{},L1=(l,i)=>l!=null&&Number.isFinite(l=+l)?l:i;function H1(l){return!!(l&&ht(l.append)&&l[ig]==="FormData"&&l[fo])}const q1=l=>{const i=new Array(10),c=(s,f)=>{if(bi(s)){if(i.indexOf(s)>=0)return;if(gi(s))return s;if(!("toJSON"in s)){i[f]=s;const d=cl(s)?[]:{};return xi(s,(h,x)=>{const b=c(h,f+1);!ll(b)&&(d[x]=b)}),i[f]=void 0,d}}return s};return c(l,0)},Y1=Xt("AsyncFunction"),V1=l=>l&&(bi(l)||ht(l))&&ht(l.then)&&ht(l.catch),fg=((l,i)=>l?setImmediate:i?((c,s)=>(ha.addEventListener("message",({source:f,data:d})=>{f===ha&&d===c&&s.length&&s.shift()()},!1),f=>{s.push(f),ha.postMessage(c,"*")}))(`axios@${Math.random()}`,[]):c=>setTimeout(c))(typeof setImmediate=="function",ht(ha.postMessage)),G1=typeof queueMicrotask<"u"?queueMicrotask.bind(ha):typeof process<"u"&&process.nextTick||fg,X1=l=>l!=null&&ht(l[fo]),M={isArray:cl,isArrayBuffer:rg,isBuffer:gi,isFormData:g1,isArrayBufferView:o1,isString:s1,isNumber:og,isBoolean:c1,isObject:bi,isPlainObject:Jr,isEmptyObject:u1,isReadableStream:x1,isRequest:y1,isResponse:v1,isHeaders:S1,isUndefined:ll,isDate:f1,isFile:d1,isBlob:p1,isRegExp:M1,isFunction:ht,isStream:m1,isURLSearchParams:b1,isTypedArray:A1,isFileList:h1,forEach:xi,merge:su,extend:j1,trim:w1,stripBOM:N1,inherits:E1,toFlatObject:z1,kindOf:po,kindOfTest:Xt,endsWith:T1,toArray:C1,forEachEntry:R1,matchAll:_1,isHTMLForm:O1,hasOwnProperty:em,hasOwnProp:em,reduceDescriptors:ug,freezeMethods:k1,toObjectSet:U1,toCamelCase:D1,noop:B1,toFiniteNumber:L1,findKey:sg,global:ha,isContextDefined:cg,isSpecCompliantForm:H1,toJSONObject:q1,isAsyncFn:Y1,isThenable:V1,setImmediate:fg,asap:G1,isIterable:X1};function ce(l,i,c,s,f){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack,this.message=l,this.name="AxiosError",i&&(this.code=i),c&&(this.config=c),s&&(this.request=s),f&&(this.response=f,this.status=f.status?f.status:null)}M.inherits(ce,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:M.toJSONObject(this.config),code:this.code,status:this.status}}});const dg=ce.prototype,pg={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(l=>{pg[l]={value:l}});Object.defineProperties(ce,pg);Object.defineProperty(dg,"isAxiosError",{value:!0});ce.from=(l,i,c,s,f,d)=>{const h=Object.create(dg);M.toFlatObject(l,h,function(y){return y!==Error.prototype},g=>g!=="isAxiosError");const x=l&&l.message?l.message:"Error",b=i==null&&l?l.code:i;return ce.call(h,x,b,c,s,f),l&&h.cause==null&&Object.defineProperty(h,"cause",{value:l,configurable:!0}),h.name=l&&l.name||"Error",d&&Object.assign(h,d),h};const Q1=null;function cu(l){return M.isPlainObject(l)||M.isArray(l)}function hg(l){return M.endsWith(l,"[]")?l.slice(0,-2):l}function tm(l,i,c){return l?l.concat(i).map(function(f,d){return f=hg(f),!c&&d?"["+f+"]":f}).join(c?".":""):i}function Z1(l){return M.isArray(l)&&!l.some(cu)}const J1=M.toFlatObject(M,{},null,function(i){return/^is[A-Z]/.test(i)});function mo(l,i,c){if(!M.isObject(l))throw new TypeError("target must be an object");i=i||new FormData,c=M.toFlatObject(c,{metaTokens:!0,dots:!1,indexes:!1},!1,function(N,T){return!M.isUndefined(T[N])});const s=c.metaTokens,f=c.visitor||y,d=c.dots,h=c.indexes,b=(c.Blob||typeof Blob<"u"&&Blob)&&M.isSpecCompliantForm(i);if(!M.isFunction(f))throw new TypeError("visitor must be a function");function g(C){if(C===null)return"";if(M.isDate(C))return C.toISOString();if(M.isBoolean(C))return C.toString();if(!b&&M.isBlob(C))throw new ce("Blob is not supported. Use a Buffer instead.");return M.isArrayBuffer(C)||M.isTypedArray(C)?b&&typeof Blob=="function"?new Blob([C]):Buffer.from(C):C}function y(C,N,T){let V=C;if(C&&!T&&typeof C=="object"){if(M.endsWith(N,"{}"))N=s?N:N.slice(0,-2),C=JSON.stringify(C);else if(M.isArray(C)&&Z1(C)||(M.isFileList(C)||M.endsWith(N,"[]"))&&(V=M.toArray(C)))return N=hg(N),V.forEach(function(G,F){!(M.isUndefined(G)||G===null)&&i.append(h===!0?tm([N],F,d):h===null?N:N+"[]",g(G))}),!1}return cu(C)?!0:(i.append(tm(T,N,d),g(C)),!1)}const v=[],O=Object.assign(J1,{defaultVisitor:y,convertValue:g,isVisitable:cu});function L(C,N){if(!M.isUndefined(C)){if(v.indexOf(C)!==-1)throw Error("Circular reference detected in "+N.join("."));v.push(C),M.forEach(C,function(V,X){(!(M.isUndefined(V)||V===null)&&f.call(i,V,M.isString(X)?X.trim():X,N,O))===!0&&L(V,N?N.concat(X):[X])}),v.pop()}}if(!M.isObject(l))throw new TypeError("data must be an object");return L(l),i}function nm(l){const i={"!":"%21","'":"%27","(":"%28",")":"%29","~":"%7E","%20":"+","%00":"\0"};return encodeURIComponent(l).replace(/[!'()~]|%20|%00/g,function(s){return i[s]})}function Au(l,i){this._pairs=[],l&&mo(l,this,i)}const mg=Au.prototype;mg.append=function(i,c){this._pairs.push([i,c])};mg.toString=function(i){const c=i?function(s){return i.call(this,s,nm)}:nm;return this._pairs.map(function(f){return c(f[0])+"="+c(f[1])},"").join("&")};function K1(l){return encodeURIComponent(l).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+")}function gg(l,i,c){if(!i)return l;const s=c&&c.encode||K1;M.isFunction(c)&&(c={serialize:c});const f=c&&c.serialize;let d;if(f?d=f(i,c):d=M.isURLSearchParams(i)?i.toString():new Au(i,c).toString(s),d){const h=l.indexOf("#");h!==-1&&(l=l.slice(0,h)),l+=(l.indexOf("?")===-1?"?":"&")+d}return l}class am{constructor(){this.handlers=[]}use(i,c,s){return this.handlers.push({fulfilled:i,rejected:c,synchronous:s?s.synchronous:!1,runWhen:s?s.runWhen:null}),this.handlers.length-1}eject(i){this.handlers[i]&&(this.handlers[i]=null)}clear(){this.handlers&&(this.handlers=[])}forEach(i){M.forEach(this.handlers,function(s){s!==null&&i(s)})}}const bg={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},F1=typeof URLSearchParams<"u"?URLSearchParams:Au,$1=typeof FormData<"u"?FormData:null,W1=typeof Blob<"u"?Blob:null,P1={isBrowser:!0,classes:{URLSearchParams:F1,FormData:$1,Blob:W1},protocols:["http","https","file","blob","url","data"]},Ru=typeof window<"u"&&typeof document<"u",uu=typeof navigator=="object"&&navigator||void 0,I1=Ru&&(!uu||["ReactNative","NativeScript","NS"].indexOf(uu.product)<0),ev=typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope&&typeof self.importScripts=="function",tv=Ru&&window.location.href||"http://localhost",nv=Object.freeze(Object.defineProperty({__proto__:null,hasBrowserEnv:Ru,hasStandardBrowserEnv:I1,hasStandardBrowserWebWorkerEnv:ev,navigator:uu,origin:tv},Symbol.toStringTag,{value:"Module"})),at={...nv,...P1};function av(l,i){return mo(l,new at.classes.URLSearchParams,{visitor:function(c,s,f,d){return at.isNode&&M.isBuffer(c)?(this.append(s,c.toString("base64")),!1):d.defaultVisitor.apply(this,arguments)},...i})}function lv(l){return M.matchAll(/\w+|\[(\w*)]/g,l).map(i=>i[0]==="[]"?"":i[1]||i[0])}function iv(l){const i={},c=Object.keys(l);let s;const f=c.length;let d;for(s=0;s<f;s++)d=c[s],i[d]=l[d];return i}function xg(l){function i(c,s,f,d){let h=c[d++];if(h==="__proto__")return!0;const x=Number.isFinite(+h),b=d>=c.length;return h=!h&&M.isArray(f)?f.length:h,b?(M.hasOwnProp(f,h)?f[h]=[f[h],s]:f[h]=s,!x):((!f[h]||!M.isObject(f[h]))&&(f[h]=[]),i(c,s,f[h],d)&&M.isArray(f[h])&&(f[h]=iv(f[h])),!x)}if(M.isFormData(l)&&M.isFunction(l.entries)){const c={};return M.forEachEntry(l,(s,f)=>{i(lv(s),f,c,0)}),c}return null}function rv(l,i,c){if(M.isString(l))try{return(i||JSON.parse)(l),M.trim(l)}catch(s){if(s.name!=="SyntaxError")throw s}return(c||JSON.stringify)(l)}const yi={transitional:bg,adapter:["xhr","http","fetch"],transformRequest:[function(i,c){const s=c.getContentType()||"",f=s.indexOf("application/json")>-1,d=M.isObject(i);if(d&&M.isHTMLForm(i)&&(i=new FormData(i)),M.isFormData(i))return f?JSON.stringify(xg(i)):i;if(M.isArrayBuffer(i)||M.isBuffer(i)||M.isStream(i)||M.isFile(i)||M.isBlob(i)||M.isReadableStream(i))return i;if(M.isArrayBufferView(i))return i.buffer;if(M.isURLSearchParams(i))return c.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),i.toString();let x;if(d){if(s.indexOf("application/x-www-form-urlencoded")>-1)return av(i,this.formSerializer).toString();if((x=M.isFileList(i))||s.indexOf("multipart/form-data")>-1){const b=this.env&&this.env.FormData;return mo(x?{"files[]":i}:i,b&&new b,this.formSerializer)}}return d||f?(c.setContentType("application/json",!1),rv(i)):i}],transformResponse:[function(i){const c=this.transitional||yi.transitional,s=c&&c.forcedJSONParsing,f=this.responseType==="json";if(M.isResponse(i)||M.isReadableStream(i))return i;if(i&&M.isString(i)&&(s&&!this.responseType||f)){const h=!(c&&c.silentJSONParsing)&&f;try{return JSON.parse(i,this.parseReviver)}catch(x){if(h)throw x.name==="SyntaxError"?ce.from(x,ce.ERR_BAD_RESPONSE,this,null,this.response):x}}return i}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:at.classes.FormData,Blob:at.classes.Blob},validateStatus:function(i){return i>=200&&i<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};M.forEach(["delete","get","head","post","put","patch"],l=>{yi.headers[l]={}});const ov=M.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]),sv=l=>{const i={};let c,s,f;return l&&l.split(`
`).forEach(function(h){f=h.indexOf(":"),c=h.substring(0,f).trim().toLowerCase(),s=h.substring(f+1).trim(),!(!c||i[c]&&ov[c])&&(c==="set-cookie"?i[c]?i[c].push(s):i[c]=[s]:i[c]=i[c]?i[c]+", "+s:s)}),i},lm=Symbol("internals");function si(l){return l&&String(l).trim().toLowerCase()}function Kr(l){return l===!1||l==null?l:M.isArray(l)?l.map(Kr):String(l)}function cv(l){const i=Object.create(null),c=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let s;for(;s=c.exec(l);)i[s[1]]=s[2];return i}const uv=l=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(l.trim());function Wc(l,i,c,s,f){if(M.isFunction(s))return s.call(this,i,c);if(f&&(i=c),!!M.isString(i)){if(M.isString(s))return i.indexOf(s)!==-1;if(M.isRegExp(s))return s.test(i)}}function fv(l){return l.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(i,c,s)=>c.toUpperCase()+s)}function dv(l,i){const c=M.toCamelCase(" "+i);["get","set","has"].forEach(s=>{Object.defineProperty(l,s+c,{value:function(f,d,h){return this[s].call(this,i,f,d,h)},configurable:!0})})}let mt=class{constructor(i){i&&this.set(i)}set(i,c,s){const f=this;function d(x,b,g){const y=si(b);if(!y)throw new Error("header name must be a non-empty string");const v=M.findKey(f,y);(!v||f[v]===void 0||g===!0||g===void 0&&f[v]!==!1)&&(f[v||b]=Kr(x))}const h=(x,b)=>M.forEach(x,(g,y)=>d(g,y,b));if(M.isPlainObject(i)||i instanceof this.constructor)h(i,c);else if(M.isString(i)&&(i=i.trim())&&!uv(i))h(sv(i),c);else if(M.isObject(i)&&M.isIterable(i)){let x={},b,g;for(const y of i){if(!M.isArray(y))throw TypeError("Object iterator must return a key-value pair");x[g=y[0]]=(b=x[g])?M.isArray(b)?[...b,y[1]]:[b,y[1]]:y[1]}h(x,c)}else i!=null&&d(c,i,s);return this}get(i,c){if(i=si(i),i){const s=M.findKey(this,i);if(s){const f=this[s];if(!c)return f;if(c===!0)return cv(f);if(M.isFunction(c))return c.call(this,f,s);if(M.isRegExp(c))return c.exec(f);throw new TypeError("parser must be boolean|regexp|function")}}}has(i,c){if(i=si(i),i){const s=M.findKey(this,i);return!!(s&&this[s]!==void 0&&(!c||Wc(this,this[s],s,c)))}return!1}delete(i,c){const s=this;let f=!1;function d(h){if(h=si(h),h){const x=M.findKey(s,h);x&&(!c||Wc(s,s[x],x,c))&&(delete s[x],f=!0)}}return M.isArray(i)?i.forEach(d):d(i),f}clear(i){const c=Object.keys(this);let s=c.length,f=!1;for(;s--;){const d=c[s];(!i||Wc(this,this[d],d,i,!0))&&(delete this[d],f=!0)}return f}normalize(i){const c=this,s={};return M.forEach(this,(f,d)=>{const h=M.findKey(s,d);if(h){c[h]=Kr(f),delete c[d];return}const x=i?fv(d):String(d).trim();x!==d&&delete c[d],c[x]=Kr(f),s[x]=!0}),this}concat(...i){return this.constructor.concat(this,...i)}toJSON(i){const c=Object.create(null);return M.forEach(this,(s,f)=>{s!=null&&s!==!1&&(c[f]=i&&M.isArray(s)?s.join(", "):s)}),c}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([i,c])=>i+": "+c).join(`
`)}getSetCookie(){return this.get("set-cookie")||[]}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(i){return i instanceof this?i:new this(i)}static concat(i,...c){const s=new this(i);return c.forEach(f=>s.set(f)),s}static accessor(i){const s=(this[lm]=this[lm]={accessors:{}}).accessors,f=this.prototype;function d(h){const x=si(h);s[x]||(dv(f,h),s[x]=!0)}return M.isArray(i)?i.forEach(d):d(i),this}};mt.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]);M.reduceDescriptors(mt.prototype,({value:l},i)=>{let c=i[0].toUpperCase()+i.slice(1);return{get:()=>l,set(s){this[c]=s}}});M.freezeMethods(mt);function Pc(l,i){const c=this||yi,s=i||c,f=mt.from(s.headers);let d=s.data;return M.forEach(l,function(x){d=x.call(c,d,f.normalize(),i?i.status:void 0)}),f.normalize(),d}function yg(l){return!!(l&&l.__CANCEL__)}function ul(l,i,c){ce.call(this,l??"canceled",ce.ERR_CANCELED,i,c),this.name="CanceledError"}M.inherits(ul,ce,{__CANCEL__:!0});function vg(l,i,c){const s=c.config.validateStatus;!c.status||!s||s(c.status)?l(c):i(new ce("Request failed with status code "+c.status,[ce.ERR_BAD_REQUEST,ce.ERR_BAD_RESPONSE][Math.floor(c.status/100)-4],c.config,c.request,c))}function pv(l){const i=/^([-+\w]{1,25})(:?\/\/|:)/.exec(l);return i&&i[1]||""}function hv(l,i){l=l||10;const c=new Array(l),s=new Array(l);let f=0,d=0,h;return i=i!==void 0?i:1e3,function(b){const g=Date.now(),y=s[d];h||(h=g),c[f]=b,s[f]=g;let v=d,O=0;for(;v!==f;)O+=c[v++],v=v%l;if(f=(f+1)%l,f===d&&(d=(d+1)%l),g-h<i)return;const L=y&&g-y;return L?Math.round(O*1e3/L):void 0}}function mv(l,i){let c=0,s=1e3/i,f,d;const h=(g,y=Date.now())=>{c=y,f=null,d&&(clearTimeout(d),d=null),l(...g)};return[(...g)=>{const y=Date.now(),v=y-c;v>=s?h(g,y):(f=g,d||(d=setTimeout(()=>{d=null,h(f)},s-v)))},()=>f&&h(f)]}const Ir=(l,i,c=3)=>{let s=0;const f=hv(50,250);return mv(d=>{const h=d.loaded,x=d.lengthComputable?d.total:void 0,b=h-s,g=f(b),y=h<=x;s=h;const v={loaded:h,total:x,progress:x?h/x:void 0,bytes:b,rate:g||void 0,estimated:g&&x&&y?(x-h)/g:void 0,event:d,lengthComputable:x!=null,[i?"download":"upload"]:!0};l(v)},c)},im=(l,i)=>{const c=l!=null;return[s=>i[0]({lengthComputable:c,total:l,loaded:s}),i[1]]},rm=l=>(...i)=>M.asap(()=>l(...i)),gv=at.hasStandardBrowserEnv?((l,i)=>c=>(c=new URL(c,at.origin),l.protocol===c.protocol&&l.host===c.host&&(i||l.port===c.port)))(new URL(at.origin),at.navigator&&/(msie|trident)/i.test(at.navigator.userAgent)):()=>!0,bv=at.hasStandardBrowserEnv?{write(l,i,c,s,f,d,h){if(typeof document>"u")return;const x=[`${l}=${encodeURIComponent(i)}`];M.isNumber(c)&&x.push(`expires=${new Date(c).toUTCString()}`),M.isString(s)&&x.push(`path=${s}`),M.isString(f)&&x.push(`domain=${f}`),d===!0&&x.push("secure"),M.isString(h)&&x.push(`SameSite=${h}`),document.cookie=x.join("; ")},read(l){if(typeof document>"u")return null;const i=document.cookie.match(new RegExp("(?:^|; )"+l+"=([^;]*)"));return i?decodeURIComponent(i[1]):null},remove(l){this.write(l,"",Date.now()-864e5,"/")}}:{write(){},read(){return null},remove(){}};function xv(l){return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(l)}function yv(l,i){return i?l.replace(/\/?\/$/,"")+"/"+i.replace(/^\/+/,""):l}function Sg(l,i,c){let s=!xv(i);return l&&(s||c==!1)?yv(l,i):i}const om=l=>l instanceof mt?{...l}:l;function ga(l,i){i=i||{};const c={};function s(g,y,v,O){return M.isPlainObject(g)&&M.isPlainObject(y)?M.merge.call({caseless:O},g,y):M.isPlainObject(y)?M.merge({},y):M.isArray(y)?y.slice():y}function f(g,y,v,O){if(M.isUndefined(y)){if(!M.isUndefined(g))return s(void 0,g,v,O)}else return s(g,y,v,O)}function d(g,y){if(!M.isUndefined(y))return s(void 0,y)}function h(g,y){if(M.isUndefined(y)){if(!M.isUndefined(g))return s(void 0,g)}else return s(void 0,y)}function x(g,y,v){if(v in i)return s(g,y);if(v in l)return s(void 0,g)}const b={url:d,method:d,data:d,baseURL:h,transformRequest:h,transformResponse:h,paramsSerializer:h,timeout:h,timeoutMessage:h,withCredentials:h,withXSRFToken:h,adapter:h,responseType:h,xsrfCookieName:h,xsrfHeaderName:h,onUploadProgress:h,onDownloadProgress:h,decompress:h,maxContentLength:h,maxBodyLength:h,beforeRedirect:h,transport:h,httpAgent:h,httpsAgent:h,cancelToken:h,socketPath:h,responseEncoding:h,validateStatus:x,headers:(g,y,v)=>f(om(g),om(y),v,!0)};return M.forEach(Object.keys({...l,...i}),function(y){const v=b[y]||f,O=v(l[y],i[y],y);M.isUndefined(O)&&v!==x||(c[y]=O)}),c}const wg=l=>{const i=ga({},l);let{data:c,withXSRFToken:s,xsrfHeaderName:f,xsrfCookieName:d,headers:h,auth:x}=i;if(i.headers=h=mt.from(h),i.url=gg(Sg(i.baseURL,i.url,i.allowAbsoluteUrls),l.params,l.paramsSerializer),x&&h.set("Authorization","Basic "+btoa((x.username||"")+":"+(x.password?unescape(encodeURIComponent(x.password)):""))),M.isFormData(c)){if(at.hasStandardBrowserEnv||at.hasStandardBrowserWebWorkerEnv)h.setContentType(void 0);else if(M.isFunction(c.getHeaders)){const b=c.getHeaders(),g=["content-type","content-length"];Object.entries(b).forEach(([y,v])=>{g.includes(y.toLowerCase())&&h.set(y,v)})}}if(at.hasStandardBrowserEnv&&(s&&M.isFunction(s)&&(s=s(i)),s||s!==!1&&gv(i.url))){const b=f&&d&&bv.read(d);b&&h.set(f,b)}return i},vv=typeof XMLHttpRequest<"u",Sv=vv&&function(l){return new Promise(function(c,s){const f=wg(l);let d=f.data;const h=mt.from(f.headers).normalize();let{responseType:x,onUploadProgress:b,onDownloadProgress:g}=f,y,v,O,L,C;function N(){L&&L(),C&&C(),f.cancelToken&&f.cancelToken.unsubscribe(y),f.signal&&f.signal.removeEventListener("abort",y)}let T=new XMLHttpRequest;T.open(f.method.toUpperCase(),f.url,!0),T.timeout=f.timeout;function V(){if(!T)return;const G=mt.from("getAllResponseHeaders"in T&&T.getAllResponseHeaders()),$={data:!x||x==="text"||x==="json"?T.responseText:T.response,status:T.status,statusText:T.statusText,headers:G,config:l,request:T};vg(function(J){c(J),N()},function(J){s(J),N()},$),T=null}"onloadend"in T?T.onloadend=V:T.onreadystatechange=function(){!T||T.readyState!==4||T.status===0&&!(T.responseURL&&T.responseURL.indexOf("file:")===0)||setTimeout(V)},T.onabort=function(){T&&(s(new ce("Request aborted",ce.ECONNABORTED,l,T)),T=null)},T.onerror=function(F){const $=F&&F.message?F.message:"Network Error",ee=new ce($,ce.ERR_NETWORK,l,T);ee.event=F||null,s(ee),T=null},T.ontimeout=function(){let F=f.timeout?"timeout of "+f.timeout+"ms exceeded":"timeout exceeded";const $=f.transitional||bg;f.timeoutErrorMessage&&(F=f.timeoutErrorMessage),s(new ce(F,$.clarifyTimeoutError?ce.ETIMEDOUT:ce.ECONNABORTED,l,T)),T=null},d===void 0&&h.setContentType(null),"setRequestHeader"in T&&M.forEach(h.toJSON(),function(F,$){T.setRequestHeader($,F)}),M.isUndefined(f.withCredentials)||(T.withCredentials=!!f.withCredentials),x&&x!=="json"&&(T.responseType=f.responseType),g&&([O,C]=Ir(g,!0),T.addEventListener("progress",O)),b&&T.upload&&([v,L]=Ir(b),T.upload.addEventListener("progress",v),T.upload.addEventListener("loadend",L)),(f.cancelToken||f.signal)&&(y=G=>{T&&(s(!G||G.type?new ul(null,l,T):G),T.abort(),T=null)},f.cancelToken&&f.cancelToken.subscribe(y),f.signal&&(f.signal.aborted?y():f.signal.addEventListener("abort",y)));const X=pv(f.url);if(X&&at.protocols.indexOf(X)===-1){s(new ce("Unsupported protocol "+X+":",ce.ERR_BAD_REQUEST,l));return}T.send(d||null)})},wv=(l,i)=>{const{length:c}=l=l?l.filter(Boolean):[];if(i||c){let s=new AbortController,f;const d=function(g){if(!f){f=!0,x();const y=g instanceof Error?g:this.reason;s.abort(y instanceof ce?y:new ul(y instanceof Error?y.message:y))}};let h=i&&setTimeout(()=>{h=null,d(new ce(`timeout ${i} of ms exceeded`,ce.ETIMEDOUT))},i);const x=()=>{l&&(h&&clearTimeout(h),h=null,l.forEach(g=>{g.unsubscribe?g.unsubscribe(d):g.removeEventListener("abort",d)}),l=null)};l.forEach(g=>g.addEventListener("abort",d));const{signal:b}=s;return b.unsubscribe=()=>M.asap(x),b}},jv=function*(l,i){let c=l.byteLength;if(c<i){yield l;return}let s=0,f;for(;s<c;)f=s+i,yield l.slice(s,f),s=f},Nv=async function*(l,i){for await(const c of Ev(l))yield*jv(c,i)},Ev=async function*(l){if(l[Symbol.asyncIterator]){yield*l;return}const i=l.getReader();try{for(;;){const{done:c,value:s}=await i.read();if(c)break;yield s}}finally{await i.cancel()}},sm=(l,i,c,s)=>{const f=Nv(l,i);let d=0,h,x=b=>{h||(h=!0,s&&s(b))};return new ReadableStream({async pull(b){try{const{done:g,value:y}=await f.next();if(g){x(),b.close();return}let v=y.byteLength;if(c){let O=d+=v;c(O)}b.enqueue(new Uint8Array(y))}catch(g){throw x(g),g}},cancel(b){return x(b),f.return()}},{highWaterMark:2})},cm=64*1024,{isFunction:qr}=M,zv=(({Request:l,Response:i})=>({Request:l,Response:i}))(M.global),{ReadableStream:um,TextEncoder:fm}=M.global,dm=(l,...i)=>{try{return!!l(...i)}catch{return!1}},Tv=l=>{l=M.merge.call({skipUndefined:!0},zv,l);const{fetch:i,Request:c,Response:s}=l,f=i?qr(i):typeof fetch=="function",d=qr(c),h=qr(s);if(!f)return!1;const x=f&&qr(um),b=f&&(typeof fm=="function"?(C=>N=>C.encode(N))(new fm):async C=>new Uint8Array(await new c(C).arrayBuffer())),g=d&&x&&dm(()=>{let C=!1;const N=new c(at.origin,{body:new um,method:"POST",get duplex(){return C=!0,"half"}}).headers.has("Content-Type");return C&&!N}),y=h&&x&&dm(()=>M.isReadableStream(new s("").body)),v={stream:y&&(C=>C.body)};f&&["text","arrayBuffer","blob","formData","stream"].forEach(C=>{!v[C]&&(v[C]=(N,T)=>{let V=N&&N[C];if(V)return V.call(N);throw new ce(`Response type '${C}' is not supported`,ce.ERR_NOT_SUPPORT,T)})});const O=async C=>{if(C==null)return 0;if(M.isBlob(C))return C.size;if(M.isSpecCompliantForm(C))return(await new c(at.origin,{method:"POST",body:C}).arrayBuffer()).byteLength;if(M.isArrayBufferView(C)||M.isArrayBuffer(C))return C.byteLength;if(M.isURLSearchParams(C)&&(C=C+""),M.isString(C))return(await b(C)).byteLength},L=async(C,N)=>{const T=M.toFiniteNumber(C.getContentLength());return T??O(N)};return async C=>{let{url:N,method:T,data:V,signal:X,cancelToken:G,timeout:F,onDownloadProgress:$,onUploadProgress:ee,responseType:J,headers:le,withCredentials:me="same-origin",fetchOptions:Re}=wg(C),Z=i||fetch;J=J?(J+"").toLowerCase():"text";let fe=wv([X,G&&G.toAbortSignal()],F),Ae=null;const ke=fe&&fe.unsubscribe&&(()=>{fe.unsubscribe()});let Ve;try{if(ee&&g&&T!=="get"&&T!=="head"&&(Ve=await L(le,V))!==0){let S=new c(N,{method:"POST",body:V,duplex:"half"}),k;if(M.isFormData(V)&&(k=S.headers.get("content-type"))&&le.setContentType(k),S.body){const[Q,W]=im(Ve,Ir(rm(ee)));V=sm(S.body,cm,Q,W)}}M.isString(me)||(me=me?"include":"omit");const B=d&&"credentials"in c.prototype,K={...Re,signal:fe,method:T.toUpperCase(),headers:le.normalize().toJSON(),body:V,duplex:"half",credentials:B?me:void 0};Ae=d&&new c(N,K);let te=await(d?Z(Ae,Re):Z(N,K));const P=y&&(J==="stream"||J==="response");if(y&&($||P&&ke)){const S={};["status","statusText","headers"].forEach(re=>{S[re]=te[re]});const k=M.toFiniteNumber(te.headers.get("content-length")),[Q,W]=$&&im(k,Ir(rm($),!0))||[];te=new s(sm(te.body,cm,Q,()=>{W&&W(),ke&&ke()}),S)}J=J||"text";let D=await v[M.findKey(v,J)||"text"](te,C);return!P&&ke&&ke(),await new Promise((S,k)=>{vg(S,k,{data:D,headers:mt.from(te.headers),status:te.status,statusText:te.statusText,config:C,request:Ae})})}catch(B){throw ke&&ke(),B&&B.name==="TypeError"&&/Load failed|fetch/i.test(B.message)?Object.assign(new ce("Network Error",ce.ERR_NETWORK,C,Ae),{cause:B.cause||B}):ce.from(B,B&&B.code,C,Ae)}}},Cv=new Map,jg=l=>{let i=l&&l.env||{};const{fetch:c,Request:s,Response:f}=i,d=[s,f,c];let h=d.length,x=h,b,g,y=Cv;for(;x--;)b=d[x],g=y.get(b),g===void 0&&y.set(b,g=x?new Map:Tv(i)),y=g;return g};jg();const _u={http:Q1,xhr:Sv,fetch:{get:jg}};M.forEach(_u,(l,i)=>{if(l){try{Object.defineProperty(l,"name",{value:i})}catch{}Object.defineProperty(l,"adapterName",{value:i})}});const pm=l=>`- ${l}`,Av=l=>M.isFunction(l)||l===null||l===!1;function Rv(l,i){l=M.isArray(l)?l:[l];const{length:c}=l;let s,f;const d={};for(let h=0;h<c;h++){s=l[h];let x;if(f=s,!Av(s)&&(f=_u[(x=String(s)).toLowerCase()],f===void 0))throw new ce(`Unknown adapter '${x}'`);if(f&&(M.isFunction(f)||(f=f.get(i))))break;d[x||"#"+h]=f}if(!f){const h=Object.entries(d).map(([b,g])=>`adapter ${b} `+(g===!1?"is not supported by the environment":"is not available in the build"));let x=c?h.length>1?`since :
`+h.map(pm).join(`
...
`+d):s.stack=d}catch{}}throw s}}_request(i,c){typeof i=="string"?(c=c||{},c.url=i):c=i||{},c=ga(this.defaults,c);const{transitional:s,paramsSerializer:f,headers:d}=c;s!==void 0&&Fr.assertOptions(s,{silentJSONParsing:Ft.transitional(Ft.boolean),forcedJSONParsing:Ft.transitional(Ft.boolean),clarifyTimeoutError:Ft.transitional(Ft.boolean)},!1),f!=null&&(M.isFunction(f)?c.paramsSerializer={serialize:f}:Fr.assertOptions(f,{encode:Ft.function,serialize:Ft.function},!0)),c.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?c.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:c.allowAbsoluteUrls=!0),Fr.assertOptions(c,{baseUrl:Ft.spelling("baseURL"),withXsrfToken:Ft.spelling("withXSRFToken")},!0),c.method=(c.method||this.defaults.method||"get").toLowerCase();let h=d&&M.merge(d.common,d[c.method]);d&&M.forEach(["delete","get","head","post","put","patch","common"],C=>{delete d[C]}),c.headers=mt.concat(h,d);const x=[];let b=!0;this.interceptors.request.forEach(function(N){typeof N.runWhen=="function"&&N.runWhen(c)===!1||(b=b&&N.synchronous,x.unshift(N.fulfilled,N.rejected))});const g=[];this.interceptors.response.forEach(function(N){g.push(N.fulfilled,N.rejected)});let y,v=0,O;if(!b){const C=[hm.bind(this),void 0];for(C.unshift(...x),C.push(...g),O=C.length,y=Promise.resolve(c);v<O;)y=y.then(C[v++],C[v++]);return y}O=x.length;let L=c;for(;v<O;){const C=x[v++],N=x[v++];try{L=C(L)}catch(T){N.call(this,T);break}}try{y=hm.call(this,L)}catch(C){return Promise.reject(C)}for(v=0,O=g.length;v<O;)y=y.then(g[v++],g[v++]);return y}getUri(i){i=ga(this.defaults,i);const c=Sg(i.baseURL,i.url,i.allowAbsoluteUrls);return gg(c,i.params,i.paramsSerializer)}};M.forEach(["delete","get","head","options"],function(i){ma.prototype[i]=function(c,s){return this.request(ga(s||{},{method:i,url:c,data:(s||{}).data}))}});M.forEach(["post","put","patch"],function(i){function c(s){return function(d,h,x){return this.request(ga(x||{},{method:i,headers:s?{"Content-Type":"multipart/form-data"}:{},url:d,data:h}))}}ma.prototype[i]=c(),ma.prototype[i+"Form"]=c(!0)});let Ov=class zg{constructor(i){if(typeof i!="function")throw new TypeError("executor must be a function.");let c;this.promise=new Promise(function(d){c=d});const s=this;this.promise.then(f=>{if(!s._listeners)return;let d=s._listeners.length;for(;d-- >0;)s._listeners[d](f);s._listeners=null}),this.promise.then=f=>{let d;const h=new Promise(x=>{s.subscribe(x),d=x}).then(f);return h.cancel=function(){s.unsubscribe(d)},h},i(function(d,h,x){s.reason||(s.reason=new ul(d,h,x),c(s.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(i){if(this.reason){i(this.reason);return}this._listeners?this._listeners.push(i):this._listeners=[i]}unsubscribe(i){if(!this._listeners)return;const c=this._listeners.indexOf(i);c!==-1&&this._listeners.splice(c,1)}toAbortSignal(){const i=new AbortController,c=s=>{i.abort(s)};return this.subscribe(c),i.signal.unsubscribe=()=>this.unsubscribe(c),i.signal}static source(){let i;return{token:new zg(function(f){i=f}),cancel:i}}};function Dv(l){return function(c){return l.apply(null,c)}}function Mv(l){return M.isObject(l)&&l.isAxiosError===!0}const fu={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511,WebServerIsDown:521,ConnectionTimedOut:522,OriginIsUnreachable:523,TimeoutOccurred:524,SslHandshakeFailed:525,InvalidSslCertificate:526};Object.entries(fu).forEach(([l,i])=>{fu[i]=l});function Tg(l){const i=new ma(l),c=lg(ma.prototype.request,i);return M.extend(c,ma.prototype,i,{allOwnKeys:!0}),M.extend(c,i,null,{allOwnKeys:!0}),c.create=function(f){return Tg(ga(l,f))},c}const Ye=Tg(yi);Ye.Axios=ma;Ye.CanceledError=ul;Ye.CancelToken=Ov;Ye.isCancel=yg;Ye.VERSION=Eg;Ye.toFormData=mo;Ye.AxiosError=ce;Ye.Cancel=Ye.CanceledError;Ye.all=function(i){return Promise.all(i)};Ye.spread=Dv;Ye.isAxiosError=Mv;Ye.mergeConfig=ga;Ye.AxiosHeaders=mt;Ye.formToJSON=l=>xg(M.isHTMLForm(l)?new FormData(l):l);Ye.getAdapter=Ng.getAdapter;Ye.HttpStatusCode=fu;Ye.default=Ye;const{Axios:a5,AxiosError:l5,CanceledError:i5,isCancel:r5,CancelToken:o5,VERSION:s5,all:c5,Cancel:u5,isAxiosError:f5,spread:d5,toFormData:p5,AxiosHeaders:h5,HttpStatusCode:m5,formToJSON:g5,getAdapter:b5,mergeConfig:x5}=Ye,ba=Ye.create({baseURL:"https://jansanwadserver.onrender.com/api",headers:{"Content-Type":"application/json"}});ba.interceptors.request.use(l=>(l.data instanceof FormData&&delete l.headers["Content-Type"],l));const Cg="/assets/ajivir5-DJJi1rt9.jpeg";function kv(){const l=wn(),[i,c]=E.useState("password"),[s,f]=E.useState({username:"",password:""}),[d,h]=E.useState(!1),[x,b]=E.useState(""),[g,y]=E.useState(!1),[v,O]=E.useState("mobile"),[L,C]=E.useState(""),[N,T]=E.useState(["","","","","",""]),[V,X]=E.useState(""),[G,F]=E.useState(0),[$,ee]=E.useState(!1),[J,le]=E.useState(!1),me=E.useRef([]),Re=P=>D=>f(S=>({...S,[P]:D.target.value}));E.useEffect(()=>{if(G<=0){ee(!0);return}const P=setTimeout(()=>F(D=>D-1),1e3);return()=>clearTimeout(P)},[G]);const Z=P=>`${String(Math.floor(P/60)).padStart(2,"0")}:${String(P%60).padStart(2,"0")}`,fe=async P=>{if(P.preventDefault(),b(""),!s.username||!s.password){b("सर्व fields भरा ❌");return}try{h(!0);const D=await ba.post("/citizen/login",{username:s.username.trim(),password:s.password});if(!D.data.success){b(D.data.message||"Login failed ❌");return}localStorage.setItem("citizenUser",JSON.stringify(D.data.citizen)),localStorage.setItem("citizenToken",D.data.token||""),l("/my-appointments")}catch(D){b(D?.response?.data?.message||"Server Error ❌")}finally{h(!1)}},Ae=async()=>{const P=L.trim();if(!/^[0-9]{10}$/.test(P)){b("10 अंकी valid mobile number टाका!");return}b(""),le(!0);const D=Math.floor(1e5+Math.random()*9e5).toString();X(D),F(60),ee(!1),T(["","","","","",""]);const S=`Dear Citizen ${D} is OTP for VVCMC Divyang Kalyan Management System login for citizen registration.VVCMC`,k=`https://1.rapidsms.co.in/api/push.json?apikey=67e12059b220a&route=&sender=VVMCDM&mobileno=${P}&text=${encodeURIComponent(S)}`;fetch(k,{method:"GET",mode:"no-cors"}).catch(()=>{}),O("otp"),le(!1),setTimeout(()=>me.current[0]?.focus(),120)},ke=async()=>{const P=N.join("");if(P.length<6){b("6 अंकी OTP टाका!");return}if(G<=0){b("OTP expire झाला! पुन्हा पाठवा.");return}if(P!==V){b("❌ चुकीचा OTP! पुन्हा try करा."),T(["","","","","",""]),setTimeout(()=>me.current[0]?.focus(),50);return}try{le(!0),b("");const D=await ba.post("/citizen/citizenLoginByMobile",{mobileNo:L.trim()});if(!D.data.success){b(D.data.message||"Login failed ❌");return}localStorage.setItem("citizenUser",JSON.stringify(D.data.citizen)),localStorage.setItem("citizenToken",D.data.token||""),l("/my-appointments")}catch(D){b(D?.response?.data?.message||"Server Error ❌")}finally{le(!1)}},Ve=(P,D)=>{if(!/^[0-9]?$/.test(D))return;const S=[...N];S[P]=D,T(S),D&&P<5&&me.current[P+1]?.focus()},B=(P,D)=>{D.key==="Backspace"&&!N[P]&&P>0&&me.current[P-1]?.focus()},K=P=>{P.preventDefault();const D=P.clipboardData.getData("text").replace(/\D/g,"").slice(0,6),S=[...N];D.split("").forEach((k,Q)=>{S[Q]=k}),T(S),me.current[Math.min(D.length,5)]?.focus()},te=P=>{c(P),b(""),O("mobile"),T(["","","","","",""]),C(""),F(0),y(!1)};return u.jsxs(u.Fragment,{children:[u.jsx("style",{children:`
